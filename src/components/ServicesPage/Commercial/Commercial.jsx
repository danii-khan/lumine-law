        ...
        <Box width="100%" flex="1" p={0} m={0} pt={"50px"}>
          ...
          >
            ...
            >
              ...
              <GridItem
                as={Link}
                to={"/lumine-law/all-services/residential/rent-recovery"}
                color={"black"}
                border={"1px solid black"}
                borderRadius={"8px"}
                p={"2.5px 10px"}
              ...
              <GridItem
                as={Link}
                to={"/lumine-law/all-services/residential/forfeiture-notices"}
                color={"black"}
                border={"1px solid black"}
                borderRadius={"8px"}
                p={"2.5px 10px"}
              ...
              <GridItem
                as={Link}
                to={"/lumine-law/all-services/residential/break-rent"}
                color={"black"}
                border={"1px solid black"}
                borderRadius={"8px"}
                p={"2.5px 10px"}
              ...
              <GridItem
                as={Link}
                to={"/lumine-law/all-services/residential/consent-alterations"}
                color={"black"}
                border={"1px solid black"}
                borderRadius={"8px"}
                p={"2.5px 10px"}
              ...
              <GridItem
                as={Link}
                to={
                  "/lumine-law/all-services/residential/property-dilapidations"
                }
                color={"black"}
                border={"1px solid black"}
                borderRadius={"8px"}
              ...
              <GridItem
                as={Link}
                to={"/lumine-law/all-services/residential/schedules-conditions"}
                color={"black"}
                border={"1px solid black"}
                borderRadius={"8px"}
                p={"2.5px 10px"}
              ...
              <GridItem
                as={Link}
                to={"/lumine-law/all-services/residential/advice-multiple"}
                color={"black"}
                border={"1px solid black"}
                borderRadius={"8px"}
                p={"2.5px 10px"}
